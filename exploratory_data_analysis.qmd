...
The differenced plot looks more stationary, suggesting that differencing may be useful here.
...
The detrended plot looks very similar to the observed plot.
...
The differenced time series looks stationary, indicating that we amy need to difference.
...
The differenced time series looks to be stationary meaning differencing may be useful.
:::
