...
ts_lags(assault_3_ts, lags = c(12, 24, 36, 48))
```
...
```{r, echo = FALSE}
plot(decompose(assault_3_ts, "multiplicative"))
...
plot_ly(data = arrests_by_crime, 
            ...
            mode = "lines",
        showlegend = TRUE) %>%
  layout(title = "Marijuana Possesion 4, 5",
         xaxis = list(title = ""),
         yaxis = list(title = "Arrests"))
```
...
plot_ly(data = arrests_by_crime, 
            ...
            mode = "lines",
        showlegend = TRUE) %>%
  layout(title = "Controlled Substance Possession 7",
         xaxis = list(title = ""),
         yaxis = list(title = "Arrests"))
```
...
plot_ly(data = arrests_by_crime, 
            ...
            mode = "lines",
        showlegend = TRUE) %>%
  layout(title = "Assault 2, 1, or Unclassified",
         xaxis = list(title = ""),
         yaxis = list(title = "Arrests"))
```
...
plot_ly(data = arrests_by_crime, 
            ...
            mode = "lines",
        showlegend = TRUE) %>%
  layout(title = "Weapons Possession",
         xaxis = list(title = ""),
         yaxis = list(title = "Arrests"))
```
...
plot_ly(data = arrests_by_crime, 
            ...
            mode = "lines",
        showlegend = TRUE) %>%
  layout(title = "Inoxicated Driving, Alcohol",
         xaxis = list(title = ""),
         yaxis = list(title = "Arrests"))
```
